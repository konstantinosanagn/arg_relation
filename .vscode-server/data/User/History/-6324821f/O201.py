...
def gen_newsQA_helper():
    ...
    for a in ans_ranges:
        ...
        for b in tmp:
            ans_range = b.split(":")
            answers.append(repr(story)[int(ans_range[0]):int(ans_range[1])])
...
# Print each passage, question, and answers, and get user input for the correct answer location
for idx, sample in enumerate(samples):
    ...
    # Get user input for the correct answer location
    correct_answer_input = input("Enter the entire sentence(s) containing the correct answer (separated by '||' if multiple): ")
...
df.to_csv('/home/ka9vt/Projects/newsqa_sampled.csv', index=False)

print("Sampled dataset saved to /home/ka9vt/Projects/newsqa_sampled.csv")
